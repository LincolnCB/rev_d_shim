...
| 0x10           | 4             | `integ_thresh_avg`     | 15 bits | Integration threshold average                  | 16384                 | 1 to 32767                   |
| 0x14           | 5             | `integ_window`         | 32 bits | Integration window                             | 5000000               | 2048 to 0xFFFFFFFF           |
| 0x18           | 6             | `integ_en`             | 1 bit   | Integration enable                             | 1                     | 0 or 1                       |
...
- **Outputs**:
  ...
  - Out-of-bounds signals: `ctrl_en_oob`, `pow_en_oob`, `cmd_buf_reset_oob`, `data_buf_reset_oob`, `integ_thresh_avg_oob`, `integ_window_oob`, `integ_en_oob`, `boot_test_skip_oob`, `debug_oob`, `dac_cal_init_oob`, `do_dac_pre_delay_oob`.
