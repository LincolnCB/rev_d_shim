...
static command_entry_t command_table[] = {
  ...
  {"set_clk_fb", cmd_set_clk_fb, {2, 2, {-1}, "Set SPI clock feedback multiplier and divider together: <clk_fb_mult> <clk_fb_div>"}},
  {"get_clk_fb_div", cmd_get_clk_fb_div, {0, 0, {-1}, "Get SPI clock feedback divider"}},
